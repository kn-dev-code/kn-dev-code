...
class Kyle:
    def __init__(self):
        self.school = "Louisiana State University"
        self.focus = ["Cloud Infrastructure", "Full-Stack"]
        self.hobbies = ["Coding", "Weightlifting", "Sleeping"]
        self.email = "nettervillekyle@gmail.com"
```
---
